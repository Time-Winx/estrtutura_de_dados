package mapaOrdenadoABB.implementacao.source;

import java.rmi.server.ExportException;
import java.util.Iterator;

import mapaOrdenadoABB.implementacao.TADListaDeNodos.*;
import mapaOrdenadoABB.implementacao.Exceptions.*;

// Interface para uma �rvore onde os nodos podem ter uma quantidade arbitr�ria de filhos.
public interface Tree<E> extends Iterable<E> {
	...
	public Position<E> root() throws ExportException;
