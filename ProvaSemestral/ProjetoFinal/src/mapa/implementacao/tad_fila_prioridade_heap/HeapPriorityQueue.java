package mapa.implementacao.tad_fila_prioridade_heap;

import java.util.Comparator;

import mapa.implementacao.exceptions.EmptyListException;
import mapa.implementacao.exceptions.InvalidKeyException;
import mapa.implementacao.interfaces.Entry;
import mapa.implementacao.interfaces.Position;
import mapa.implementacao.interfaces.PriorityQueue;
import mapa.implementacao.tad_arvore_binaria_completa.ArrayListCompleteBinaryTree;
import mapa.implementacao.tad_arvore_binaria_completa.CompleteBinaryTree;
...
public class HeapPriorityQueue<K, V> implements PriorityQueue<K, V> {
    ...
    public Entry<K, V> min() throws EmptyListException {
        if (isEmpty()) throw new EmptyListException("Priority queue is empty");
